package com.khanh.laptopshop.service.specification;
...
import com.khanh.laptopshop.domain.Product_;
...
public class ProductSpecs {
    ...
    // case 6
    public static Specification<Product> matchMulPrice(double min, double max) {
