        ...
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <head>
                    ...
                    <title>${productById.name} - Laptopshop</title>
                </head>
                ...
                <body>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="border rounded">
                                                <a href="#">
                                                    <img src="/images/product/${productById.image}"
                                                        class="img-fluid rounded" alt="Image">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <h4 class="fw-bold mb-3">${productById.name}</h4>
                                            <p class="mb-3">Factory: ${productById.factory}</p>
                                            <h5 class="fw-bold mb-3">
                                                <fmt:formatNumber type="number" value="${productById.price}" /> Đ
                                            </h5>
                                            ...
                                            <!-- <form action="/add-product-to-cart/${productById.id}" method="post"> -->
                                            ...
                                            <button data-product-id="${productById.id}"
                                                class="btnAddToCartDetail btn border border-secondary rounded-pill px-3 text-primary"><i
                    ...
                    $(document).ready(function() {
                        ...
                        $('.btnAddToCartDetail').click(function(e) {
                            e.preventDefault();
